	...
	return{
		show:function(c,u,w,h,a,t){
			if(!f){
				...
				e=document.createElement('div'); e.id='close';
				//f=document.createElement('div'); f.id='close1';
				document.body.appendChild(m); document.body.appendChild(p); p.appendChild(b);
				p.appendChild(e);
				//p.appendChild(f);
				e.onclick=TINY.box.hide;
				//f.onclick=TINY.box.hide;
			...
			this.mask();
			ic=c; iu=u; iw=w; ih=h; ia=a; this.alpha(m,1,15,3);
			if(t){setTimeout(function(){TINY.box.hide()},500*t)}
		},
		...
		twalpha:function(e,a,d,s){
			var o=Math.round(e.style.opacity*40);
